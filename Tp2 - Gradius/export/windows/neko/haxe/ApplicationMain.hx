...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("Beto", "Tp2-Gradius", "com.example.myapp", "0.0.1");
		...
		telemetryConfig.app_name = "Tp2 - Gradius";
		#end
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "Tp2 - Gradius", null, { width: 256, height: 240 });
